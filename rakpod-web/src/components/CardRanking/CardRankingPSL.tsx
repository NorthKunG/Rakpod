  ...
  return (
    ...
    >
      <div className="flex justify-start">
        <h1 className="text-xl ipad:text-2xl font-bold text-[#00CC99]">AQI</h1>
      <h1 className=" text-xl ipad:text-2xl font-bold ml-2 " >
      (ลำดับคุณภาพอากาศ)
      </h1>
      </div>
      <h2 className="  text-base ipad:text-lg text-[#888888] font-normal leading-10    ">
        อุปกรณ์ที่มีมลพิษทางอากาศสูง
      </h2>
                ...
                {data?.data
                  .sort((a, b) =>
                    ...
                    a.environmentInformation.aqi.AQI.aqi
                      ? 1
                      : -1
                  ).filter((d) => d.environmentInformation.aqi.AQI.aqi !== null && d.name !== "มหาวิทยาลัยราชภัฏกำแพงเพชร" )
                  .map((d, i) => (
                    <TableRow
                      key={i}
                    ...
                    >
                      ...
                      <TableCell align="left" sx={{color:'#888888'}}>{d.name}</TableCell>
                      <TableCell align="center">
                        <div
                          ...
                          } w-12  text-center rounded-badge font-medium p-1 border-2 text-[#000000]`}
                        >
                          {" "}
